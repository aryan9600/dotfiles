...
if is_available "toggleterm.nvim" then
  ...
  maps.n["<F7>"] = { "<cmd>ToggleTerm direction=tab<cr>", desc = "Toggle terminal" }
  maps.t["<F7>"] = maps.n["<F7>"]
...
-- tab nav shortcuts
maps.n["tt"] = { function() vim.cmd("tabprevious") end, desc = "Go to previous tab" }
maps.n["ts"] = { function() vim.cmd("split | term") vim.cmd("setlocal nonumber norelativenumber") end, desc = "Horizontal terminal split" }
maps.n["tv"] = { function() vim.cmd("vsplit | term") vim.cmd("setlocal nonumber norelativenumber") end, desc = "Vertical terminal split" }
